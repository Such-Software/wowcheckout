...
export default async function BtcpayReceiptPage({
  ...
  const totalFiat =
    invoice.btcpay_amount && invoice.btcpay_currency && invoice.btcpay_currency !== "WOW"
  ...
  const amountPaidLabel = totalFiat ? totalFiat : `${paidXmr} WOW`;
            ...
            <section className="mt-8 rounded-xl bg-white p-6 shadow-soft">
              ...
              <div className="mt-6 text-sm text-neutral-500">
                ...
                <div className="grid grid-cols-3 gap-6 pt-4 text-neutral-900">
                  ...
                  <div className="text-right">{paidXmr} WOW</div>
                </div>
              </div>
