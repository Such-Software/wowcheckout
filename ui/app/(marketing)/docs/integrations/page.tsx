    ...
    <main className="px-[6vw] pb-20 pt-10 text-ink">
      <section className="grid max-w-[54rem] gap-4">
        ...
        <p className="text-[1.05rem] leading-relaxed text-ink-soft">
          Recipes follow the same pattern: create an invoice with a WOW amount, send
      ...
      <section id="btcpay" className="mt-10 grid gap-6 scroll-mt-24">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className={sectionCardClass}>
            ...
            <ol className="mt-3 list-decimal space-y-2 pl-5 text-ink-soft">
              <li>Sign in to WOW Checkout to get your API key.</li>
              <li>
              ...
              <li>
                ...
                <ul className="mt-2 list-disc space-y-1 pl-5">
                  ...
                  <li>API key: your WOW Checkout API key.</li>
                  <li>Payment method: WOW-CHAIN (shows as WOW_CHAIN in WooCommerce).</li>
...
export WOWCHECKOUT_BTCPAY_URL="${normalizedSiteUrl}/api/v1"
export WOWCHECKOUT_API_KEY="wowcheckout_..."

curl -sS "$WOWCHECKOUT_BTCPAY_URL/stores" \\
  -H "Authorization: token $WOWCHECKOUT_API_KEY"`}</code>
        </pre>
      </section>
...
export WOWCHECKOUT_API_BASE_URL="${publicApiBaseUrl}"
export WOWCHECKOUT_API_KEY="wowcheckout_..."
...
curl -sS "$WOWCHECKOUT_API_BASE_URL/public/invoice/$INVOICE_ID"`}</code>
          </pre>
        </div>
      </section>
