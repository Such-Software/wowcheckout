...
const buildMoneroUri = (state: InvoiceState): string | null => {
  ...
  return `wownero:${state.address}?${params.toString()}`;
};
        ...
        {amountMode === "xmr" ? (
          ...
          <div className="grid gap-3 sm:grid-cols-[minmax(0,1fr)_140px]">
            ...
            <p className="text-sm text-ink-soft sm:col-span-2">
              Fiat inputs create a WOW invoice using a non-binding rate at request time.
            </p>
            {showFiatEstimate ? (
              <div className="sm:col-span-2">
                <p className="text-sm text-ink-soft">
                  Approx. WOW value: {fiatEstimateLabel}
