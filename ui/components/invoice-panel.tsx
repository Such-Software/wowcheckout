                ...
                <div className="grid gap-6">
                    ...
                    {amountMode === "xmr" ? (
                      ...
                      <div className="grid gap-3 sm:grid-cols-[minmax(0,1fr)_140px]">
                        ...
                        <p className="text-sm text-ink-soft sm:col-span-2">
                          Fiat inputs create a WOW invoice using a non-binding rate at request
                          time.
                        </p>
                        {showFiatEstimate ? (
                          <details className="w-fit text-xs text-ink-soft sm:col-span-2">
                            <summary className="cursor-pointer select-none underline underline-offset-4">
                              Approx. WOW value: {draftXmrEstimateLabel}
                    ...
                    <div className="mt-4 grid gap-5">
                      ...
                      <div className="grid gap-2">
                        ...
                        >
                          ...
                          <option value="monero">Wownero logo</option>
                  ...
                  <div className="rounded-2xl border border-stroke bg-white/70 p-5 text-sm text-ink shadow-soft">
                    ...
                    <p className="mt-2">
                      ...
                      {amountMode === "xmr" ? "WOW" : fiatCurrencyLabel}
                    </p>
                  </div>
          ...
          >
            <div className="grid w-full gap-2 sm:max-w-lg">
              ...
              <input
                ...
                type="search"
                value={searchInput}
                placeholder="Invoice id, amount (WOW), subaddress, or metadata"
                    ...
                    <div className="mt-4 grid gap-3 sm:grid-cols-2">
                      <div className="grid gap-1">
                        ...
                        <p className="text-sm font-semibold text-ink">
                          {formatXmrAmount(invoice.amount_xmr)} WOW
                        </p>
                      </div>
                    </div>
