...
const buildMoneroUri = (address: string, amount: string) => {
  ...
  return `wownero:${address}?${params.toString()}`;
};
...
export default function BtcpayClassicCheckout({
  ...
  const totalFiat =
    btcpayAmount && btcpayCurrency && btcpayCurrency !== "WOW"
      ? formatFiatAmount(btcpayAmount, btcpayCurrency)
      : null;
  const exchangeRate =
    quote?.rate && quote.fiat_currency
      ? `1 WOW = ${formatFiatAmount(quote.rate, quote.fiat_currency)}`
      : null;
      ...
      <div className="rounded-[28px] border border-stroke bg-white px-6 py-8 shadow-card">
        ...
        <dl className="mt-6 grid gap-3 text-sm text-ink">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <dd className="font-semibold">{formattedAmount} WOW</dd>
          </div>
          <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <dd className="font-semibold">{formattedPaidAmount} WOW</dd>
          </div>
        </dl>
    ...
    <div className="rounded-[28px] border border-stroke bg-white px-6 py-8 shadow-card">
      <div className="text-center">
        ...
        <div className="mt-3 flex flex-wrap items-center justify-center gap-3">
          <p className="text-[1.9rem] font-semibold text-ink">{formattedAmount} WOW</p>
          <button
