...
BTCPAY_PAYMENT_METHOD = "WOW-CHAIN"
BTCPAY_PAYMENT_METHOD_ALIASES = {BTCPAY_PAYMENT_METHOD, "WOW", "WOW_CHAIN"}
...
def _btcpay_amount_currency(invoice: Invoice) -> tuple[str, str, dict[str, Any]]:
    ...
    return format_xmr_amount(invoice.amount_xmr), "WOW", {}
